...
The issue came from SQL connectivity:
	...
	•	Staging folder rebuilt because of hash mismatch

Fixing SQL ODBC connectivity fixed the full problem.
...
Credits
	...
	•	Structure and writing improved with ChatGPT for clarity

⸻

If you want, I can also create:
	•	A banner for the repo
	•	A short description for GitHub topics
	•	A /screenshots folder with markdown placeholders
